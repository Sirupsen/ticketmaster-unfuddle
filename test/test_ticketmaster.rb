...
class TestTicketmasterUnfuddle < Test::Unit::TestCase
  context "TicketMaster::Provider::Unfuddle" do
    setup do
      ...
      @ticket_properties = { :assignee_id => nil, :component_id => nil, :created_at => "2010-06-16T07:28:04Z", :description => "Hello World", :description_format => "markdown", :due_on => nil, :field1_value_id => nil, :field2_value_id => nil, :field3_value_id => nil, :hours_estimate_current => 0.0, :hours_estimate_initial => 0.0, :id => 169, :milestone_id => nil, :number => 112 , :priority => "3", :project_id => 2, :reporter_id => 2, :resolution => nil, :resolution_description => nil, :resolution_description_format => "markdown", :severity_id => nil, :status => "new", :summary => "Test", :updated_at => "2010-06-16T07:28:04Z", :version_id => nil, }
    ...
    context "base" do
      should "return all projects in an array" do
        p @ticketmaster.projects
      end
    end
  end
end
